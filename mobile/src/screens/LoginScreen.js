      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.header}>
            ...
            <Text style={styles.appName}>Smart Assignment Tracker</Text>
            <Text style={styles.tagline}>Mobile Academic Management</Text>
          </View>

          {/* Form Card */}
          <View style={styles.card}>
            <Text style={styles.cardTitle}>Sign In</Text>
            <Text style={styles.cardSubtitle}>Access your student, faculty, or admin portal</Text>
