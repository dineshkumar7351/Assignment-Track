            ...
            <View style={styles.welcomeRow}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={[styles.welcomeSub, { fontSize: moderateScale(12) }]}>
                  {user?.department || 'Faculty Workspace'}
                </Text>
              </View>
            ...
            <>
              ...
              <View style={styles.metricGrid}>
                ...
                >
                  ...
                  <Text style={[styles.metricNum, { color: '#4f46e5', fontSize: moderateScale(22) }]}>
                ...
                >
                  ...
                  <Text style={[styles.metricNum, { color: '#db2777', fontSize: moderateScale(22) }]}>
                    100%
                  </Text>
